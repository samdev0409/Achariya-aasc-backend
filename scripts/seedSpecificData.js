...
const CLIENT_DATA_DIR = path.resolve(
  __dirname,
  "..",
  "..",
  "client",
...
const TARGET_FILES = [
  ...
  {
    relativePath: "commitees/committiesdata.js",
    collectionName: "commitees__committiesdata",
    exportName: "committeeDataMapper",
    type: "singleton",
  },
  {
    relativePath: "_header/topheaderdata.ts",
    collectionName: "home__topheaderdata",
    exportName: "documentsData",
    type: "singleton",
  },
  {
    relativePath: "aasc-beats/aasc-beatsdata.ts",
    collectionName: "aasc_beats__aascbeatsdata",
    exportName: "aascbeatsdata",
    type: "singleton",
  },
];
